...
db_abl(i).animal           = 'FR184';
db_abl(i).mouse_name    = {'FR184','FR184','FR184','FR184','FR184','FR184','FR184','FR184'};
db_abl(i).mouse_name_s2p    = {'FR184','FR184','FR184','FR184','FR184','FR184','FR184','FR184'};
db_abl(i).date              = {'2021-04-01', '2021-04-01','2021-04-06','2021-04-07','2021-04-07','2021-04-09','2021-04-12','2021-04-12'};
db_abl(i).date_s2p      = {'2021-04-01','2021-04-01','2021-04-06','2021-04-06','2021-04-06','2021-04-09', '2021-04-12','2021-04-12'};
db_abl(i).expts         = {[11], [18 19], [14 2 3 4], [14 2 3 4], [14 2 3 4], [ 4 5 6 7], [14 15 16], [14 15 16]};
db_abl(i).expID         = {[1]   , [1],     [1],     [2],         [3],         [2] ,        [1],      [3]};
db_abl(i).plane         = [5, 3, 3, 3, 3, 4, 3, 3];
db_abl(i).starterID     = 23;
db_abl(i).stimList      = {[1:13], [1:13], [1:7:84, 85], [1:13], [1:13], [1:13], [1:13], [1:13]};
db_abl(i).ncut_dendrites     = [3  1];
db_abl(i).respWin       = [0 3];
...
db_abl(i).expts         = { [ 4 5 6 7], [11 13 15 16]};
db_abl(i).expID         = {[4] ,        [3]};
db_abl(i).plane         = [4, 4];
