...
%  generates theta colormap of each dendritic segment
% %% Step 1: load paths + resample tree
% clear; close all;
% addpath(genpath('C:\obUsers\Experiment\cameraLucida')); 
...
function [thetaMap, thetaRadialMap] = DendriteMorpho( tree, fname )
