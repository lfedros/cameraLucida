...
%    RFtimesInFrames, receptiveFields, lambdas, numShifts) determines 
%    explained variance of neural traces given their receptive fields, and 
%    explained variance of surrogate data generated by shifting the neural 
%    traces in time.
%
